...
// active link
// if($('.sidebar-wrapper .simplebar-content-wrapper') && $('#pageWrapper').hasClass('compact-wrapper')) {
//   $('.sidebar-wrapper .simplebar-content-wrapper').animate({
//       scrollTop: $('.sidebar-wrapper .simplebar-content-wrapper a.active').offset().top - 400
//   }, 1000);
// }
