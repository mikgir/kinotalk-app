...
Route::prefix('admin')->group(function () {
    Route::view('admin', 'dashboard.index')->name('admin');
...
Route::prefix('icons')->group(function () {
    ...
    Route::view('admin-line-icon', 'icons.admin-line-icon')->name('admin-line-icon');
...
Route::prefix('editors')->group(function () {
    ...
    Route::view('admin-mde', 'apps.admin-mde')->name('admin-mde');
