    ...
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
           ...
           /** Example of custom column using a closure **/
            ->addColumn('status_lower', fn (Comment $model) => strtolower(e($model->status)))
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Article id', 'article_id'),
    ...
    public function actions(): array
    {
       return [
           Button::make('edit', 'Edit')
               ...
               ->route('comment.edit', function(\App\Models\Comment $model) {
                    return $model->id;
               }),

           Button::make('destroy', 'Delete')
               ->class('bg-red-500 cursor-pointer text-white px-3 py-2 m-1 rounded text-sm')
               ->route('comment.destroy', function(\App\Models\Comment $model) {
                    return $model->id;
               })
               ->method('delete')
        ];
