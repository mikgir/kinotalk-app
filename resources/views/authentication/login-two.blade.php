...
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-xl-5"><img class="bg-img bg-center" style="margin-top: 250px" src="{{asset('assets/images/login/2_login_bg.jpg')}}" alt="looginpage"></div>
      <div class="col-xl-7 p-0">
         <div class="login-card">
            <div>
               <div><a class="logo text-start" href="{{ route('main')}}">
                       <h2>KINOTALK</h2>
