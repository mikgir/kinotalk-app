...
} elseif ($_instance->childHasBeenRendered('l1441582623-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1441582623-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1441582623-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1441582623-0');
} else {
    $response = \Livewire\Livewire::mount('components.article-card', ['article' => $article]);
    $html = $response->html();
    $_instance->logRenderedChild('l1441582623-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\OSPanel\domains\kinoyalk_dev\resources\views/livewire/front/articles/articles.blade.php ENDPATH**/ ?>