                                ...
                                <div class="card o-hidden">
                                    <div class="card-body balance-widget"><span class="f-w-500 f-light">Total Balance</span>
                                        ...
                                        <div class="mobile-right-img"><img class="left-mobile-img"
                                                src="<?php echo e(asset('assets/images/dashboard-2/widget-img.png')); ?>" alt=""><img
                                                class="mobile-img" src="<?php echo e(asset('assets/images/dashboard-2/mobile.gif')); ?>"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle me-2"
                                                            src="<?php echo e(asset('assets/images/dashboard/user/1.jpg')); ?>" alt="user"></td>
                                                    <td class="img-content-box"><a class="f-w-500"
                                                            href="<?php echo e(route('user-profile')); ?>">Jane Cooper</a><span
                                                            class="f-light">alma.lawson@gmail.com</span></td>
                                                </tr>
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle me-2"
                                                            src="<?php echo e(asset('assets/images/dashboard/user/2.jpg')); ?>" alt="user">
                                                    </td>
                                                    <td class="img-content-box"><a class="f-w-500"
                                                            href="<?php echo e(route('user-profile')); ?>">Cameron Willia</a><span
                                                            class="f-light">tim.jennings@gmail.com</span></td>
                                                </tr>
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle me-2"
                                                            src="<?php echo e(asset('assets/images/dashboard/user/9.jpg')); ?>" alt="user">
                                                    </td>
                                                    <td class="img-content-box"><a class="f-w-500"
                                                            href="<?php echo e(route('user-profile')); ?>">Floyd Miles</a><span
                                                            class="f-light">kenzi.lawson@gmail.com</span></td>
                                                </tr>
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle me-2"
                                                            src="<?php echo e(asset('assets/images/dashboard/user/5.jpg')); ?>" alt="user">
                                                    </td>
                                                    <td class="img-content-box"><a class="f-w-500"
                                                            href="<?php echo e(route('user-profile')); ?>">Dianne Russell</a><span
                                                            class="f-light">curtis.weaver@gmail.com</span></td>
                                                </tr>
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle me-2"
                                                            src="<?php echo e(asset('assets/images/dashboard/user/3.jpg')); ?>" alt="user">
                                                    </td>
                                                    <td class="img-content-box"><a class="f-w-500"
                                                            href="<?php echo e(route('user-profile')); ?>">Guy Hawkins</a><span
                                                            class="f-light">curtis.weaver@gmail.com</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist">
                                        <button class="active frame-box" id="v-pills-shirt-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-shirt" aria-selected="true"><span
                                                class="frame-image"><img src="<?php echo e(asset('assets/images/dashboard-2/order/1.png')); ?>"
                                        ...
                                        <button class="frame-box" id="v-pills-television-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-television" aria-selected="false"><span
                                                class="frame-image"><img src="<?php echo e(asset('assets/images/dashboard-2/order/2.png')); ?>"
                                        ...
                                        <button class="frame-box" id="v-pills-headphone-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-headphone" aria-selected="false"><span
                                                class="frame-image"><img src="<?php echo e(asset('assets/images/dashboard-2/order/3.png')); ?>"
                                        ...
                                        <button class="frame-box" id="v-pills-chair-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-chair" aria-selected="false"><span
                                                class="frame-image"><img src="<?php echo e(asset('assets/images/dashboard-2/order/4.png')); ?>"
                                        ...
                                        <button class="frame-box" id="v-pills-lamp-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-lamp" aria-selected="false"><span
                                                class="frame-image"><img src="<?php echo e(asset('assets/images/dashboard-2/order/5.png')); ?>"
                                                        ...
                                                        <tr>
                                                                ...
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">T-shirt</a></h6>
                                                            ...
                                                            <td class="f-w-500">
                                                                <div class="recent-status font-success">
                                                                    <svg class="me-1">
                                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#24-hour')); ?>">
                                                                        </use>
                                                                    </svg>Verified
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">Pink T-shirt</a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">Sony</a></h6>
                                                                        <span class="f-light f-12">Id : #CFDE-2163</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">Samsung</a></h6>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">Sennheiser</a>
                                                                        </h6><span class="f-light f-12">Id :
                                                                            #CFDE-2780</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">Chair</a></h6>
                                                                        <span class="f-light f-12">Id : #CFDE-2163</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">Office chair</a>
                                                                        </h6><span class="f-light f-12">Id :
                                                                            #CFDE-2780</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">Lamp</a></h6>
                                                                        <span class="f-light f-12">Id : #CFDE-2163</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="product-content">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="<?php echo e(route('order-history')); ?>">Bedside lamp</a>
                                                                        </h6><span class="f-light f-12">Id :
                                                                            #CFDE-2780</span>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="card-body pt-0">
                        <ul class="categories-list">
                            <li class="d-flex">
                                ...
                                <div>
                                    <h6 class="mb-0"><a href="<?php echo e(route('product')); ?>">Food & Drinks</a></h6><span
                            ...
                            <li class="d-flex">
                                ...
                                <div>
                                    <h6 class="mb-0"><a href="<?php echo e(route('product')); ?>">Furniture</a></h6><span
                            ...
                            <li class="d-flex">
                                ...
                                <div>
                                    <h6 class="mb-0"><a href="<?php echo e(route('product')); ?>">Grocery</a></h6><span
                            ...
                            <li class="d-flex">
                                ...
                                <div>
                                    <h6 class="mb-0"><a href="<?php echo e(route('product')); ?>">Electronics</a></h6><span
                            ...
                            <li class="d-flex">
                                <div class="bg-light"> <img src="<?php echo e(asset('assets/images/dashboard-2/category/5.png')); ?>"
                                        alt="vector toys"></div>
                                <div>
                                    <h6 class="mb-0"><a href="<?php echo e(route('product')); ?>">Toys & Games</a></h6><span
                            ...
                            <li class="d-flex">
                                ...
                                <div>
                                    <h6 class="mb-0"><a href="<?php echo e(route('product')); ?>">Desktop</a></h6><span
                            ...
                            <li class="d-flex">
                                ...
                                <div>
                                    <h6 class="mb-0"><a href="<?php echo e(route('product')); ?>">Mobile & Accessories</a></h6><span
