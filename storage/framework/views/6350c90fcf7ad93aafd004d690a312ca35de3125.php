   ...
   <div class="row">
      ...
      <div class="col-xl-7 p-0">
         <div class="login-card">
            <div>
               <div>
                   <a class="logo" href="<?php echo e(route('main')); ?>">
                       <img class="img-fluid for-light w-50" src="<?php echo e(asset('assets/front/img/logo/b_kinotalk.png')); ?>"
                            alt="looginpage">
                       <img class="img-fluid for-dark w-50" src="<?php echo e(asset('assets/front/img/logo/w_kinotalk.png')); ?>"
                            alt="looginpage">
                   </a>
               </div>
...
<?php endif; ?>
                       ...
                       <div class="form-group mb-0">
                           ...
                           <a class="link" href="<?php echo e(route('forget-password')); ?>">Забыли пароль?</a>
                       ...
                       <div class="mt-4 mb-0">
                           <p class="mt-4 mb-0">Ещё не зарегистрированы?<a class="ms-2" href="<?php echo e(route('register')); ?>">Зарегистрировать</a></p>
                       </div>
                   </form>
               </div>
            </div>
...
<?php echo $__env->make('layouts.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\kinoyalk_dev\resources\views/authentication/login-two.blade.php ENDPATH**/ ?>