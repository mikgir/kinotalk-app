		  ...
		  <div class="card-body chat-body">
			<div class="chat-box">
			  ...
			  <div class="chat-left-aside">
				<div class="media"><img class="rounded-circle user-image" src="<?php echo e(asset('assets/images/user/12.png')); ?>" alt="">
				  <div class="about">
		  ...
		  <div class="card-body p-0">
			<div class="row chat-box">
			  ...
			  <div class="col pe-0 chat-right-aside">
				...
				<div class="chat">
				  <!-- chat-header start-->
				  <div class="chat-header clearfix"><img class="rounded-circle" src="<?php echo e(asset('assets/images/user/8.jpg')); ?>" alt="">
					<div class="about">
				  ...
				  <div class="chat-history chat-msg-box custom-scrollbar">
					<ul>
					  <li>
						<div class="message my-message"><img class="rounded-circle float-start chat-user-img img-30" src="<?php echo e(asset('assets/images/user/3.png')); ?>" alt="">
					  ...
					  <li class="clearfix">
						<div class="message other-message pull-right"><img class="rounded-circle float-end chat-user-img img-30" src="<?php echo e(asset('assets/images/user/12.png')); ?>" alt="">
					  ...
					  <li>
						<div class="message my-message mb-0"><img class="rounded-circle float-start chat-user-img img-30" src="<?php echo e(asset('assets/images/user/3.png')); ?>" alt="">
				  ...
				  <div class="tab-pane fade show active" id="info-home" role="tabpanel" aria-labelledby="info-home-tab">
					<div class="people-list">
					  <ul class="list">
						...
						<li class="clearfix"><img class="rounded-circle user-image mt-0" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="">
						  <div class="about">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\kinotalk\resources\views/apps/chat.blade.php ENDPATH**/ ?>