...
} elseif ($_instance->childHasBeenRendered('87BMg7Z')) {
    $componentId = $_instance->getRenderedChildComponentId('87BMg7Z');
    $componentTag = $_instance->getRenderedChildComponentTagName('87BMg7Z');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('87BMg7Z');
} else {
    $response = \Livewire\Livewire::mount('components.header-navigation', []);
    $html = $response->html();
    $_instance->logRenderedChild('87BMg7Z', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
