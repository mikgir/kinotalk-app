...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid p-0">
        <div class="row m-0">
            <div class="col-xl-5"><img class="bg-img-cover bg-center" src="<?php echo e(asset('assets/images/login/login-bg-2.jpg')); ?>"
                                       alt="looginpage"></div>
                ...
                <div class="login-card">
                    <div>
                        ...
                        <div class="login-main">
                            <form method="POST" action="<?php echo e(route('register')); ?>" class="theme-form">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                ...
                                <div class="mt-4 mb-0">
                                    <p class="mt-4 mb-0">Уже есть аккаунт?<a class="ms-2" href="<?php echo e(route('login')); ?>">Войти</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
