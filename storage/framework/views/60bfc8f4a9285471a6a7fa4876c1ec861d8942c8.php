<div class="blog-details-wrap">
    <ul class="tgbanner__content-meta list-wrap">
        ...
        <li><?php echo e($article->update_at); ?></li>
    </ul>
    <h2 class="title"><?php echo e($article->title); ?></h2>
    <div class="blog-details-thumb">
        <img src="<?php echo e(asset($article->image)); ?>" alt="img">
    </div>
    ...
    <div class="blog-avatar-wrap">
        <div class="blog-avatar-img">
            <a href="#"><img src="<?php echo e(asset('assets/front/img/others/People2.png')); ?>" alt="img"></a>
        </div>
    ...
    <div class="blog-avatar-wrap">
        <div class="blog-avatar-img">
            <a href="#"><img src="<?php echo e(asset('assets/front/img/others/People6.png')); ?>" alt="img"></a>
        </div>
        <div class="blog-avatar-content">
    ...
    <div class="blog-avatar-wrap">
        <div class="blog-avatar-img">
            <a href="#"><img src="<?php echo e(asset('assets/front/img/others/People5.png')); ?>" alt="img"></a>
        </div>
        <div class="blog-avatar-content">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-8 col-md-6">
                <div class="pn-post-item">
                    <div class="thumb">
                        <a href="#"><img src="<?php echo e(asset('assets/front/img/lifestyle/TheLastofUs.png')); ?>" alt="img"></a>
                    </div>
                    <div class="content">
                        <span>Предыдущая статья</span>
                        <h5 class="title tgcommon__hover"><a href="#">После просмотра 1 сезона "The Last of Us"...</a></h5>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-8 col-md-6">
                <div class="pn-post-item next-post">
                    <div class="thumb">
                        <a href="#"><img src="<?php echo e(asset('assets/front/img/lifestyle/LordOfTheRings.png')); ?>" alt="img"></a>
                    </div>
                    <div class="content">
                        <span>Следующая статья</span>
                        <h5 class="title tgcommon__hover"><a href="#">Сказания о Средиземье — это хроника Великой...</a></h5>
                    </div>
                </div>
            </div>
        </div>
