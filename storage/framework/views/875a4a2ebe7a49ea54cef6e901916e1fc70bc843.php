                                        ...
                                        <div class="email-app-sidebar">
                                            <div class="media">
                                                <div class="media-size-email"><img class="me-3 rounded-circle"
                                                        src="<?php echo e(asset('assets/images/user/user.png')); ?>" alt=""></div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 xl-100 col-sm-12">
                                                                        <div class="media"><img
                                                                                ...
                                                                                src="<?php echo e(asset('assets/images/user/user.png')); ?>"
                                                                                alt="">
                                                                            <div class="media-body">
                                                                ...
                                                                <div class="attachment">
                                                                    <ul class="list-inline">
                                                                        <li class="list-inline-item"><img
                                                                                class="img-fluid"
                                                                                src="<?php echo e(asset('assets/images/email/1.jpg')); ?>"
                                                                                alt=""></li>
                                                                        <li class="list-inline-item"><img
                                                                                class="img-fluid"
                                                                                src="<?php echo e(asset('assets/images/email/2.jpg')); ?>"
                                                                                alt=""></li>
                                                                        <li class="list-inline-item"><img
                                                                                class="img-fluid"
                                                                                src="<?php echo e(asset('assets/images/email/3.jpg')); ?>"
                                                                                alt=""></li>
                                                                    </ul>
                                                                </div>
                                                                <hr>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\gb_kinotalk\kinotalk-app\resources\views/apps/email-compose.blade.php ENDPATH**/ ?>