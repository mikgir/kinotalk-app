	...
	<div class="row widget-grid">
	  <div class="col-xxl-4 col-sm-6 box-col-6">
		<div class="card profile-box">
		  <div class="card-body">
			...
			<div class="cartoon"><img class="img-fluid" src="<?php echo e(asset('assets/images/dashboard/cartoon.svg')); ?>" alt="vector women with leptop"></div>
		  </div>
		</div>
	  </div>
			  ...
			  <div class="card-body"> 
				<div class="widget-content">
				  <div class="widget-round secondary">
					<div class="bg-round">
					  <svg class="svg-fill">
						<use href="<?php echo e(asset('assets/svg/icon-sprite.svg#cart')); ?>"> </use>
					  </svg>
				...
				<div class="card-body"> 
				  <div class="widget-content">
					<div class="widget-round primary">
					  <div class="bg-round">
						<svg class="svg-fill">
						  <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#tag')); ?>"> </use>
						</svg>
						<svg class="half-circle svg-fill">
						  <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#halfcircle')); ?>"></use>
						</svg>
			  ...
			  <div class="card-body"> 
				<div class="widget-content">
				  <div class="widget-round warning">
					<div class="bg-round">
					  <svg class="svg-fill">
						<use href="<?php echo e(asset('assets/svg/icon-sprite.svg#return-box')); ?>"> </use>
					  </svg>
					  <svg class="half-circle svg-fill">
						<use href="<?php echo e(asset('assets/svg/icon-sprite.svg#halfcircle')); ?>"></use>
					  </svg>
				...
				<div class="card-body"> 
				  <div class="widget-content">
					<div class="widget-round success">
					  <div class="bg-round">
						<svg class="svg-fill">
						  <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#rate')); ?>"> </use>
						</svg>
						<svg class="half-circle svg-fill">
						  <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#halfcircle')); ?>"></use>
						</svg>
				...
				<div class="row g-sm-4 g-2">
				  <div class="col-xl-12 col-md-4">
					<div class="light-card balance-card widget-hover">
					  <div class="svg-box">
						<svg class="svg-fill">
						  <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#income')); ?>"></use>
						</svg>
					  </div>
				  ...
				  <div class="col-xl-12 col-md-4">
					<div class="light-card balance-card widget-hover">
					  <div class="svg-box">
						<svg class="svg-fill">
						  <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#doller-return')); ?>"></use>
						</svg>
					  </div>
			...
			<div class="card-body pt-0">
			  <div class="appointment-table table-responsive">
				<table class="table table-bordernone">
				  <tbody>
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="<?php echo e(asset('assets/images/dashboard/user/1.jpg')); ?>" alt="user"></td>
					  <td class="img-content-box"><a class="d-block f-w-500" href="<?php echo e(route('user-profile')); ?>">Jane Cooper</a><span class="f-light">10 minutes ago</span></td>
					  <td class="text-end">
						<p class="m-0 font-success">$200.00</p>
					  </td>
					</tr>
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="<?php echo e(asset('assets/images/dashboard/user/2.jpg')); ?>" alt="user"></td>
					  <td class="img-content-box"><a class="d-block f-w-500" href="<?php echo e(route('user-profile')); ?>">Brooklyn Simmons</a><span class="f-light">19 minutes ago</span></td>
					  <td class="text-end">
						<p class="m-0 font-success">$970.00</p>
					  </td>
					</tr>
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="<?php echo e(asset('assets/images/dashboard/user/3.jpg')); ?>" alt="user"></td>
					  <td class="img-content-box"><a class="d-block f-w-500" href="<?php echo e(route('user-profile')); ?>">Leslie Alexander</a><span class="f-light">2 hours ago</span></td>
					  <td class="text-end">
						<p class="m-0 font-success">$300.00</p>
					  </td>
					</tr>
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="<?php echo e(asset('assets/images/dashboard/user/4.jpg')); ?>" alt="user"></td>
					  <td class="img-content-box"><a class="d-block f-w-500" href="<?php echo e(route('user-profile')); ?>">Travis Wright</a><span class="f-light">8 hours ago</span></td>
					  <td class="text-end">
						<p class="m-0 font-success">$450.00</p>
					  </td>
					</tr>
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="<?php echo e(asset('assets/images/dashboard/user/5.jpg')); ?>" alt="user"></td>
					  <td class="img-content-box"><a class="d-block f-w-500" href="<?php echo e(route('user-profile')); ?>">Mark Green</a><span class="f-light">1 day ago</span></td>
					  <td class="text-end">
	  ...
	  <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6"> 
		<div class="card papernote-wrap">
		  ...
		  <div class="card-body pt-0"> <img class="banner-img img-fluid" src="<?php echo e(asset('assets/images/dashboard/papernote.jpg')); ?>" alt="multicolor background">
			  ...
			  <div class="mt-sm-4 mt-2 user-details">
				<div class="customers">
				  <ul> 
					...
					<li class="d-inline-block"><img class="img-40 rounded-circle" src="<?php echo e(asset('assets/images/dashboard/user/3.jpg')); ?>" alt="user"></li>
					<li class="d-inline-block"><img class="img-40 rounded-circle" src="<?php echo e(asset('assets/images/dashboard/user/8.jpg')); ?>" alt="user"></li>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiots/Desktop/cuba-laravel/template/resources/views/dashboard/index.blade.php ENDPATH**/ ?>