      ...
      <ul class="nav-menus">
        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <div class="cart-dropdown onhover-show-div">
            ...
            <ul>
              <li>
                <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="<?php echo e(asset('assets/images/other-images/cart-img.jpg')); ?>" alt="">
        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          <div class="media profile-media"><img class="b-r-10" src="<?php echo e(asset('assets/images/dashboard/profile.png')); ?>" alt="">
