            ...
            <div class="col-sm-6 col-xl-3 col-lg-6 box-col-6">
                <div class="card widget-1">
                    <div class="card-body">
                        ...
                        <div class="font-success f-w-500"><i class="icon-arrow-up icon-rotate me-1"></i><span>+70%</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card course-box widget-course">
                            <div class="card-body">
                                <div class="course-widget">
                                    ...
                                    <div>
                                        <h4 class="mb-0">100+</h4><span class="f-light">Completed Courses</span><a
                                            class="btn btn-light f-light" href="<?php echo e(route('learning-list-view')); ?>">View course<span
                                                class="ms-2">
                        ...
                        <div class="card course-box widget-course">
                            <div class="card-body">
                                <div class="course-widget">
                                    ...
                                    <div>
                                        <h4 class="mb-0">50+</h4><span class="f-light">In Progress Courses</span><a
                                            class="btn btn-light f-light" href="<?php echo e(route('learning-list-view')); ?>">View course<span
                                                class="ms-2">
                                                <svg class="fill-icon f-light">
                                                    <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#arrowright')); ?>"></use>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <div class="social-icons"><img src="<?php echo e(asset('assets/images/dashboard-5/social/1.png')); ?>"
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card social-widget">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <div class="social-icons"><img src="<?php echo e(asset('assets/images/dashboard-5/social/3.png')); ?>"
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card social-widget">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <div class="social-icons"><img src="<?php echo e(asset('assets/images/dashboard-5/social/2.png')); ?>"
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card social-widget">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <div class="social-icons"><img src="<?php echo e(asset('assets/images/dashboard-5/social/4.png')); ?>"
                                        alt="you tube icon"></div><span>Youtube</span>
                            </div><span class="font-success f-12 d-xxl-block d-xl-none">+22.9%</span>
                        </div>
                        <div class="social-content">
                            <div>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <div class="balance-profile">
                            <div class="balance-img"><img src="<?php echo e(asset('assets/images/dashboard-4/user.png')); ?>"
                                    alt="user vector"><a class="edit-icon" href="<?php echo e(route('user-profile')); ?>">
                                    <svg>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\kinotalk\resources\views/widgets/general-widget.blade.php ENDPATH**/ ?>