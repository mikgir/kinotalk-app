                                            ...
                                            <div class="customers text-center social-group">
                                                <ul>
                                                    <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                            src="<?php echo e(asset('assets/images/user/3.jpg')); ?>" alt=""
                                                    ...
                                                    <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                            src="<?php echo e(asset('assets/images/user/2.png')); ?>" alt=""
                                                            data-container="body" data-bs-toggle="tooltip"
                                                            title="Bucky Barnes"></li>
                                                    <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                            src="<?php echo e(asset('assets/images/user/8.jpg')); ?>" alt=""
                                                            data-container="body" data-bs-toggle="tooltip"
                                                            title="Jason Borne"></li>
                                                    <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                            src="<?php echo e(asset('assets/images/user/11.png')); ?>" alt=""
                                                            data-container="body" data-bs-toggle="tooltip"
                                                            title="Comeren Diaz"></li>
                                                </ul>
                                            </div><img class="img-fluid mt-5" alt=""
                                                src="<?php echo e(asset('assets/images/social-app/timeline-3.png')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div class="collapse show" id="collapseTwo" aria-labelledby="headingTwo"
                                        ...
                                        <div class="card-body social-status filter-cards-view">
                                            ...
                                            <div class="media"><img class="img-50 rounded-circle m-r-15"
                                                    src="<?php echo e(asset('assets/images/user/10.jpg')); ?>" alt="">
                                            ...
                                            <div class="media"><img class="img-50 rounded-circle m-r-15"
                                                    src="<?php echo e(asset('assets/images/user/14.png')); ?>" alt="">
                                                <div class="social-status social-online"></div>
                                            ...
                                            <div class="media"><img class="img-50 rounded-circle m-r-15"
                                                    src="<?php echo e(asset('assets/images/user/3.png')); ?>" alt="">
                                                <div class="social-status social-offline"></div>
                                                <div class="media-body"><span class="f-w-600 d-block">Johny
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="new-users-social">
                                                ...
                                                src="<?php echo e(asset('assets/images/social-app/timeline-1.png')); ?>">
                                                ...
                                                <div class="social-chat">
                                                    <div class="your-msg">
                                                        <div class="media"><img
                                                                ...
                                                                alt="" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="new-users-social">
                                                ...
                                                src="<?php echo e(asset('assets/images/social-app/timeline-2.png')); ?>">
                                            <div class="timeline-content">
                                                <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse sed
                                                    urna in justo euismod condimentum. Fusce
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 xl-50 box-col-6">
                                        <div class="card"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/social-app/timeline-4.png')); ?>" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                ...
                                                                src="<?php echo e(asset('assets/images/user/2.png')); ?>"><span
                                                    ...
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                class="img-60 img-fluid rounded-circle" alt=""
                                                                src="<?php echo e(asset('assets/images/user/3.png')); ?>"><span
                                                    ...
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                class="img-60 img-fluid rounded-circle" alt=""
                                                                src="<?php echo e(asset('assets/images/user/3.jpg')); ?>"><span
                                                    ...
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                class="img-60 img-fluid rounded-circle" alt=""
                                                                src="<?php echo e(asset('assets/images/user/4.jpg')); ?>"><span
                                                    ...
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                class="img-60 img-fluid rounded-circle" alt=""
                                                                src="<?php echo e(asset('assets/images/user/8.jpg')); ?>"><span
                                                    ...
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                class="img-60 img-fluid rounded-circle" alt=""
                                                                src="<?php echo e(asset('assets/images/user/10.jpg')); ?>"><span
                                                    ...
                                                    <li>
                                                        <div class="add-friend text-center"><img
                                                                class="img-60 img-fluid rounded-circle" alt=""
                                                                src="<?php echo e(asset('assets/images/user/14.png')); ?>"><span
                                                                class="d-block">Karlene Lex</span>
                                                            <button class="btn btn-primary btn-xs">Add Friend</button>
                                                        </div>
                                                    </li>
                                                ...
                                                <div class="card-body photos filter-cards-view px-0">
                                                    <ul class="text-center">
                                                        ...
                                                        <li>
                                                            <div class="latest-post"><img class="img-fluid"
                                                                    alt=""
                                                                    src="<?php echo e(asset('assets/images/social-app/post-9.png')); ?>"></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="card social-profile">
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img src="<?php echo e(asset('assets/images/dashboard-5/profile.png')); ?>"
                                                alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="<?php echo e(route('social-app')); ?>">Brooklyn Simmons</a></h5><span
                                ...
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/avtar/3.jpg')); ?>" alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#profile-check')); ?>"></use>
                                            </svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="<?php echo e(route('social-app')); ?>">Mark Jecno</a></h5><span
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/avtar/11.jpg')); ?>" alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#profile-check')); ?>"></use>
                                            </svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="<?php echo e(route('social-app')); ?>">Dev John</a></h5><span
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/avtar/16.jpg')); ?>" alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#profile-check')); ?>"></use>
                                            </svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="<?php echo e(route('social-app')); ?>">Johan Deo</a></h5><span
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/user/7.jpg')); ?>" alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#profile-check')); ?>"></use>
                                            </svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="<?php echo e(route('social-app')); ?>">Douglas Reichel</a></h5><span
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/avtar/4.jpg')); ?>" alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#profile-check')); ?>"></use>
                                            </svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="<?php echo e(route('social-app')); ?>">Lisa lillian</a></h5><span
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#profile-check')); ?>"></use>
                                            </svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="<?php echo e(route('social-app')); ?>">Olivia rose</a></h5><span
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/user/2.png')); ?>" alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#profile-check')); ?>"></use>
                                            </svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="<?php echo e(route('social-app')); ?>">Sarah Karen</a></h5><span
                            ...
                            <div class="card">
                                <div class="my-gallery card-body row gallery-with-description" itemscope="">
                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            ...
                                            data-size="1600x950"><img src="<?php echo e(asset('assets/images/lightgallry/01.jpg')); ?>"
                                    ...
                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            ...
                                            data-size="1600x950"><img src="<?php echo e(asset('assets/images/lightgallry/02.jpg')); ?>"
                                                itemprop="thumbnail" alt="Image description">
                                            <div class="caption">
                                                <h4>Dev John</h4>
                                                <p>is simply dummy text of the printing and typesetting industry. Lorem
                                    ...
                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            ...
                                            data-size="1600x950"><img src="<?php echo e(asset('assets/images/lightgallry/03.jpg')); ?>"
                                                itemprop="thumbnail" alt="Image description">
                                            <div class="caption">
                                                <h4>Johan Deo</h4>
                                                <p>is simply dummy text of the printing and typesetting industry. Lorem
                                    ...
                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            ...
                                            data-size="1600x950"><img src="<?php echo e(asset('assets/images/lightgallry/04.jpg')); ?>"
                                                itemprop="thumbnail" alt="Image description">
                                            <div class="caption">
                                                <h4>Comeren Diaz</h4>
                                                <p>is simply dummy text of the printing and typesetting industry. Lorem
                                    ...
                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            ...
                                            data-size="1600x950"><img src="<?php echo e(asset('assets/images/lightgallry/05.jpg')); ?>"
                                                itemprop="thumbnail" alt="Image description">
                                            <div class="caption">
                                                <h4>Andew Jon</h4>
                                                <p>is simply dummy text of the printing and typesetting industry. Lorem
                                    ...
                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            ...
                                            data-size="1600x950"><img src="<?php echo e(asset('assets/images/lightgallry/011.jpg')); ?>"
                                                itemprop="thumbnail" alt="Image description">
                                            <div class="caption">
                                                <h4>Sarah Loren</h4>
                                                <p>is simply dummy text of the printing and typesetting industry. Lorem
                                    ...
                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            ...
                                            data-size="1600x950"><img src="<?php echo e(asset('assets/images/lightgallry/010.jpg')); ?>"
                                                itemprop="thumbnail" alt="Image description">
                                            <div class="caption">
                                                <h4>Andew Jon</h4>
                                                <p>is simply dummy text of the printing and typesetting industry. Lorem
                                    ...
                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            ...
                                            data-size="1600x950"><img src="<?php echo e(asset('assets/images/lightgallry/08.jpg')); ?>"
                                                itemprop="thumbnail" alt="Image description">
                                            <div class="caption">
                                                <h4>Bucky Barnes</h4>
                                                <p>is simply dummy text of the printing and typesetting industry. Lorem
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\gb_kinotalk\kinotalk-app\resources\views/apps/social-app.blade.php ENDPATH**/ ?>