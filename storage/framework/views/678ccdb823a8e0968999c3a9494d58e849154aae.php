             ...
             <div class="row">
               <div class="col-xl-4 col-md-12 box-md-12 pr-0">
                 ...
                 <div class="inbox">
                   ...
                   <div class="media media-size-email"><img class="me-3 rounded-circle" src="<?php echo e(asset('assets/images/user/user.png')); ?>" alt="">
                     <div class="media-body">
                       <h6>Lion Lorpa  <small><span>(02</span> Jun <span>2016)</span></small></h6>
                       <p>Mattis luctus. Donec nisi diam,</p>
                     </div>
                             ...
                             <div class="email-top">
                               <div class="row">
                                 <div class="col-md-6 xl-100 col-sm-12">
                                   <div class="media"><img class="me-3 rounded-circle" src="<?php echo e(asset('assets/images/user/user.png')); ?>" alt="">
                                     <div class="media-body">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\gb_kinotalk\kinotalk-app\resources\views/apps/email-application.blade.php ENDPATH**/ ?>