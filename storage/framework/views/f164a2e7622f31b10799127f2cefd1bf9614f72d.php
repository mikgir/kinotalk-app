                    ...
                    <div class="card-body chat-body">
                        <div class="chat-box">
                            ...
                            <div class="chat-left-aside">
                                <div class="media"><img class="rounded-circle user-image" src="<?php echo e(asset('assets/images/user/12.png')); ?>"
                                        alt="">
                                    <div class="about">
                                    ...
                                    <div class="chat-history">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7 ps-0 caller-img"><img class="img-fluid"
                                                    src="<?php echo e(asset('assets/images/other-images/caller.jpg')); ?>" alt=""></div>
                                        </div>
                                    </div>
                                    <!-- chat-history ends-->
                                    <!-- chat end-->
                                        ...
                                        <div class="user-profile">
                                            <div class="image">
                                                <div class="avatar text-center"><img alt=""
                                                        src="<?php echo e(asset('assets/images/user/2.png')); ?>"></div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\kinotalk\resources\views/apps/video-chat.blade.php ENDPATH**/ ?>